...
helm install new-api oci://ghcr.io/douglarek/newapi-helm/new-api --version 0.2.5 -n <namespace> --create-namespace

# Pull to local
helm pull oci://ghcr.io/douglarek/newapi-helm/new-api --version 0.2.5
```
...
| `image.tag` | Image tag | `v0.13.1-patch.1` |
