...
helm install new-api oci://ghcr.io/douglarek/newapi-helm/new-api --version 0.3.2 -n <namespace> --create-namespace

# Pull to local
helm pull oci://ghcr.io/douglarek/newapi-helm/new-api --version 0.3.2
```
...
| `image.tag` | Image tag | `v1.0.0-rc.4` |
